  ...
  return (
    <section id="internet-calculator" className="bg-slate-50 py-4 sm:py-5 lg:py-6">
      <div className="mx-auto w-full max-w-[1344px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 grid items-stretch gap-5 xl:grid-cols-[minmax(0,1fr)_380px]">
          <div className="flex min-w-0 flex-col gap-6">
            <div
              id="internet-selection"
              className="scroll-mt-24 rounded-[28px] border border-slate-200 bg-white px-5 py-6 shadow-[0_16px_50px_rgba(15,23,42,0.05)] sm:px-7 lg:px-8 lg:py-7"
            >
